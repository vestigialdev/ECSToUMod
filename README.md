...
<root>
  ...
  ├── Editor
  │   ├── Vestigial.Ecstoumod.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Vestigial.Ecstoumod.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Vestigial.Ecstoumod.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Vestigial.Ecstoumod.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Vestigial.Ecstoumod`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package ECSToUMod Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Vestigial.Ecstoumod.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Vestigial.Ecstoumod.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Vestigial.Ecstoumod.Editor.Tests.asmdef`

  `Tests/Runtime/Vestigial.Ecstoumod.Tests.asmdef`
